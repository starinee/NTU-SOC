...
def main():
    ...
    _, _, train_frames, test_frames = module.load_temperature_frames(manifest, 10, rows_dir)
    df = module.run_training_suite(
        ...
        device,
        "within_10degC_only",
        module.OUTPUT_ROOT / "within_temperature/10degC_parallel_line",
    )
    full = module.add_averages(df)
    out_dir = module.OUTPUT_ROOT / "within_temperature/10degC_parallel_line"
