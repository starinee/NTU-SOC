...
OUTPUT_DIR = PROJECT_ROOT / "dataset/processed/cnn_lstm_student_25degC"

STUDENT_CONFIG = {
    "model_name": "cnn_lstm_student_25degC",
    "conv_channels": 16,
    "lstm_hidden": 16,
    "dense_hidden": 8,
    "dropout": 0.05,
...
def main():
    ...
    print(f"Tiny CNN-LSTM student parameters: {param_count:,}")
    ...
    results_df = evaluate_model_on_splits(
        ...
        output_dir=OUTPUT_DIR,
        device=device,
        prediction_col="soc_cnn_lstm_student",
        method_name="Tiny CNN-LSTM Student",
    )
    results_path = OUTPUT_DIR / "cnn_lstm_student_25degC_summary.csv"
    results_df.to_csv(results_path, index=False)

    checkpoint_path = OUTPUT_DIR / "cnn_lstm_student_25degC_model.pt"
    save_checkpoint(
        checkpoint_path,
        model,
        STUDENT_CONFIG,
